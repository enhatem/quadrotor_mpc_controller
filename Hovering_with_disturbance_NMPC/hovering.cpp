...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    ModelFcn_1_f = mxCreateString("ode1");
    ...
    ModelFcn_2X  = mxCreateDoubleMatrix( 2, 1,mxREAL );
    ModelFcn_2XA = mxCreateDoubleMatrix( 0, 1,mxREAL );
    ModelFcn_2DX = mxCreateDoubleMatrix( 2, 1,mxREAL );
    ModelFcn_2U  = mxCreateDoubleMatrix( 1, 1,mxREAL );
    ModelFcn_2P  = mxCreateDoubleMatrix( 0, 1,mxREAL );
    ModelFcn_2W  = mxCreateDoubleMatrix( 1, 1,mxREAL );
    ModelFcn_2NT  = 1;
    ModelFcn_2NX  = 2;
    ModelFcn_2NXA = 0;
    ModelFcn_2NDX = 2;
    ...
    ModelFcn_2_f = mxCreateString("ode2");
    IntermediateState setc_is_2(5);
