...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    ocp1.subjectTo(0.00000000000000000000e+00 <= F1 <= 2.64869999999999994333e-01);
    ocp1.subjectTo(0.00000000000000000000e+00 <= F2 <= 2.64869999999999994333e-01);
    ocp1.subjectTo(0.00000000000000000000e+00 <= F3 <= 2.64869999999999994333e-01);
    ocp1.subjectTo(0.00000000000000000000e+00 <= F4 <= 2.64869999999999994333e-01);
